...
SYSTEM_PROMPT = (
    ...
    "temas o menos (si hay más de 5, usa barras aunque `tipo_grafica` diga 'pastel'). El gráfico "
    "de cada pregunta debe representar TODOS los temas de su `valores_caracteristicos`, no solo "
    "los 2 o 3 más grandes — si una pregunta trae 7 temas, su gráfico tiene 7 barras o 7 "
    "porciones, sin recortar. Cada barra o porción lleva su etiqueta de tema y su porcentaje real "
    "impreso al lado. Las preguntas sin cuantificación (`metodo_valores` distinto de "
    "`bertopic_llm`/`conteo`, o sin temas) igual llevan su propia tarjeta, con la descripción en "
    "texto — nunca se omiten por no tener gráfica. Cuando una pregunta traiga `nivel_acuerdo`, "
